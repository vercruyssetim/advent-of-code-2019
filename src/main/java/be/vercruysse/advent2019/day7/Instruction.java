...
import be.vercruysse.advent2019.day7.opcode.*;
import be.vercruysse.advent2019.day7.reader.ImmediateMode;
import be.vercruysse.advent2019.day7.reader.ParamerReader;
import be.vercruysse.advent2019.day7.reader.PositionMode;
...
public class Instruction {
    ...
    public static Instruction instruction(char[] instruction, Amplifier amplifier) {
        return new Instruction(toOpcode(instruction, amplifier), getParamerReaders(instruction));
    }
    ...
    private static Opcode toOpcode(char[] instruction, Amplifier amplifier) {
        ...
        switch (opcode) {
            ...
            case "03":
                return new InputOpcode(amplifier);
            case "04":
                return new OutputOpcode(amplifier);
            case "05":
